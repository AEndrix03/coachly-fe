...
class VoiceAliases extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  VoiceAliases(this.attachedDatabase, [this._alias]);
  ...
  @override
  VoiceAliases createAlias(String alias) {
    return VoiceAliases(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(phrase)'];
  @override
  bool get dontWriteConstraints => true;
}

class VoiceResolutionLogs extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  VoiceResolutionLogs(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  VoiceResolutionLogs createAlias(String alias) {
    return VoiceResolutionLogs(attachedDatabase, alias);
  }
...
class DatabaseAtV2 extends GeneratedDatabase {
  ...
  late final VoiceAliases voiceAliases = VoiceAliases(this);
  late final VoiceResolutionLogs voiceResolutionLogs = VoiceResolutionLogs(
    this,
  );
  @override
