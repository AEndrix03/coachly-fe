...
class SessionEvents extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SessionEvents(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  SessionEvents createAlias(String alias) {
    return SessionEvents(attachedDatabase, alias);
  }
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final SessionEvents sessionEvents = SessionEvents(this);
