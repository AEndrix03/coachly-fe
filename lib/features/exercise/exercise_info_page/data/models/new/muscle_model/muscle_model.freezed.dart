...
$MuscleModelCopyWith<MuscleModel> get copyWith => _$MuscleModelCopyWithImpl<MuscleModel>(this as MuscleModel, _$identity);
  ...
  /// Serializes this MuscleModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MuscleModel&&(identical(other.id, id) || other.id == id)&&(identical(other.code, code) || other.code == code)&&const DeepCollectionEquality().equals(other.nameI18n, nameI18n)&&const DeepCollectionEquality().equals(other.descriptionI18n, descriptionI18n));
}
...
@override
String toString() {
  return 'MuscleModel(id: $id, code: $code, nameI18n: $nameI18n, descriptionI18n: $descriptionI18n)';
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MuscleModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MuscleModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MuscleModel value)  $default,){
final _that = this;
switch (_that) {
case _MuscleModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MuscleModel value)?  $default,){
final _that = this;
switch (_that) {
case _MuscleModel() when $default != null:
return $default(_that);case _:
...
class _MuscleModel implements MuscleModel {
  const _MuscleModel({required this.id, required this.code, required final  Map<String, String> nameI18n, required final  Map<String, String> descriptionI18n}): _nameI18n = nameI18n,_descriptionI18n = descriptionI18n;
  factory _MuscleModel.fromJson(Map<String, dynamic> json) => _$MuscleModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$MuscleModelCopyWith<_MuscleModel> get copyWith => __$MuscleModelCopyWithImpl<_MuscleModel>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MuscleModel&&(identical(other.id, id) || other.id == id)&&(identical(other.code, code) || other.code == code)&&const DeepCollectionEquality().equals(other._nameI18n, _nameI18n)&&const DeepCollectionEquality().equals(other._descriptionI18n, _descriptionI18n));
}
...
/// @nodoc
abstract mixin class _$MuscleModelCopyWith<$Res> implements $MuscleModelCopyWith<$Res> {
  factory _$MuscleModelCopyWith(_MuscleModel value, $Res Function(_MuscleModel) _then) = __$MuscleModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String code, Map<String, String> nameI18n, Map<String, String> descriptionI18n
});
...
/// @nodoc
class __$MuscleModelCopyWithImpl<$Res>
    implements _$MuscleModelCopyWith<$Res> {
  __$MuscleModelCopyWithImpl(this._self, this._then);

  final _MuscleModel _self;
  final $Res Function(_MuscleModel) _then;
