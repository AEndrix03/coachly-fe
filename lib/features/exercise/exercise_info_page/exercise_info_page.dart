            ...
            children: [
              ...
              ExerciseVideoSection(
                ...
                exerciseName:
                    ...
                    exercise.id ??
                    'N/A',
                tags: (exercise.tags ?? const [])
                    .map((t) => t.nameI18n?.fromI18n(locale) ?? t.code ?? 'N/A')
                    .toList(),
              ),
              const SizedBox(height: 24),
              ExerciseStatsCards(
                difficulty: exercise.difficultyLevel ?? 'N/A',
                mechanics: exercise.mechanicsType ?? 'N/A',
                type: exercise.forceType ?? 'N/A',
              ),
              const SizedBox(height: 24),
            ],
          ),
        ...
        SliverFillRemaining(
          child: TabBarView(
            ...
            children: [
              ...
              ExerciseMusclesTab(muscles: exercise.muscles ?? const []),
              ExerciseVariantsTab(variants: exercise.variants ?? const []),
            ],
          ),
        ),
      ],
