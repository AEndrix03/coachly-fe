...
final Map<String, ArbResolver> arbBridge = <String, ArbResolver>{
  ...
  'ai.create_workout': (l10n, _) => l10n.aiCreateWorkout,
  'ai.analyze_progress': (l10n, _) => l10n.aiAnalyzeProgress,
  'ai.goal_tips': (l10n, _) => l10n.aiGoalTips,
  'ai.greeting': (l10n, _) => l10n.aiGreeting,
  'ai.sample_question': (l10n, _) => l10n.aiSampleQuestion,
  'ai.sample_answer': (l10n, _) => l10n.aiSampleAnswer,
  ...
  'ai.header_ready': (l10n, _) => l10n.aiHeaderReady,
  'ai.plan_week': (l10n, _) => l10n.aiPlanWeek,
  'ai.write_message': (l10n, _) => l10n.aiWriteMessage,
  'ai.loading': (l10n, _) => l10n.aiLoading,
  'ai.monitor_workout': (l10n, _) => l10n.aiMonitorWorkout,
  'ai.listening': (l10n, _) => l10n.aiListening,
  'ai.speak_now': (l10n, _) => l10n.aiSpeakNow,
  'ai.send': (l10n, _) => l10n.aiSend,
  'ai.write_or_speak': (l10n, _) => l10n.aiWriteOrSpeak,
  'ai.live': (l10n, _) => l10n.aiLive,
  'ai.now': (l10n, _) => l10n.aiNow,
  'ai.minutes_ago': (l10n, params) => l10n.aiMinutesAgo(params['value'] ?? ''),
  'ai.context_line': (l10n, params) => l10n.aiContextLine(
    params['exercise'] ?? '',
    params['current'] ?? '',
    params['total'] ?? '',
    params['weight'] ?? '',
  ...
  'ai.quick.adjust': (l10n, _) => l10n.aiQuickAdjust,
  'ai.quick.progress': (l10n, _) => l10n.aiQuickProgress,
  'ai.quick.fatigue': (l10n, _) => l10n.aiQuickFatigue,
  'ai.quick.next': (l10n, _) => l10n.aiQuickNext,
  'ai.quick.nutrition': (l10n, _) => l10n.aiQuickNutrition,
  'ai.default_opening': (l10n, _) => l10n.aiDefaultOpening,
  'ai.model_unavailable': (l10n, _) => l10n.aiModelUnavailable,
  'ai.model_loading_retry': (l10n, _) => l10n.aiModelLoadingRetry,
  'ai.retry_short': (l10n, _) => l10n.aiRetryShort,
  'ai.json_fallback': (l10n, _) => l10n.aiJsonFallback,
  'ai.message_fallback': (l10n, _) => l10n.aiMessageFallback,
  'ai.context_loading_exercise': (l10n, _) => l10n.aiContextLoadingExercise,
  'ai.prompt.system.en': (l10n, _) => l10n.aiPromptSystemEn,
  'ai.prompt.context_title': (l10n, _) => l10n.aiPromptContextTitle,
  'ai.prompt.user_title': (l10n, _) => l10n.aiPromptUserTitle,
  'ai.prompt.exercise_line': (l10n, params) => l10n.aiPromptExerciseLine(
    params['name'] ?? '',
    params['current'] ?? '',
    params['total'] ?? '',
  ),
  'ai.prompt.weight_line': (l10n, params) =>
      l10n.aiPromptWeightLine(params['weight'] ?? '', params['reps'] ?? ''),
  'ai.prompt.fatigue_line': (l10n, params) =>
      l10n.aiPromptFatigueLine(params['value'] ?? ''),
  'ai.prompt.recent_weights_line': (l10n, params) =>
      l10n.aiPromptRecentWeightsLine(params['value'] ?? ''),
  'ai.prompt.minutes_line': (l10n, params) =>
      l10n.aiPromptMinutesLine(params['value'] ?? ''),
  'ai.offline.body': (l10n, params) =>
      l10n.aiOfflineBody(params['value'] ?? '', params['exercise'] ?? ''),
  'ai.offline.body_default': (l10n, _) => l10n.aiOfflineBodyDefault,
  'ai.offline.message': (l10n, params) =>
      l10n.aiOfflineMessage(params['message'] ?? ''),
  'ai.offline.label': (l10n, _) => l10n.aiOfflineLabel,
  'ai.download.title': (l10n, _) => l10n.aiDownloadTitle,
  'ai.download.subtitle': (l10n, _) => l10n.aiDownloadSubtitle,
  'ai.download.description': (l10n, _) => l10n.aiDownloadDescription,
  'ai.download.button': (l10n, _) => l10n.aiDownloadButton,
  'ai.download.progress': (l10n, params) =>
      l10n.aiDownloadProgress(params['progress'] ?? ''),
  'ai.download.error': (l10n, _) => l10n.aiDownloadError,
  'settings.local_ai.section': (l10n, _) => l10n.settingsLocalAiSection,
  'settings.local_ai.toggle': (l10n, _) => l10n.settingsLocalAiToggle,
  'settings.local_ai.toggle_subtitle': (l10n, _) =>
      l10n.settingsLocalAiToggleSubtitle,
  'settings.local_ai.model_quality': (l10n, _) =>
      l10n.settingsLocalAiModelQuality,
  'settings.local_ai.model_minimal': (l10n, _) =>
      l10n.settingsLocalAiModelMinimal,
  'settings.local_ai.model_good': (l10n, _) => l10n.settingsLocalAiModelGood,
  'settings.local_ai.model_best': (l10n, _) => l10n.settingsLocalAiModelBest,
  'settings.local_ai.uninstall_all': (l10n, _) =>
      l10n.settingsLocalAiUninstallAll,
  'settings.local_ai.uninstall_title': (l10n, _) =>
      l10n.settingsLocalAiUninstallTitle,
  'settings.local_ai.uninstall_body': (l10n, _) =>
      l10n.settingsLocalAiUninstallBody,
  'settings.local_ai.uninstall_confirm': (l10n, _) =>
      l10n.settingsLocalAiUninstallConfirm,
  'settings.local_ai.enable_title': (l10n, _) =>
      l10n.settingsLocalAiEnableTitle,
  'settings.local_ai.storage_info': (l10n, params) =>
      l10n.settingsLocalAiStorageInfo(params['size'] ?? ''),
  'settings.local_ai.no_cost': (l10n, _) => l10n.settingsLocalAiNoCost,
  'settings.local_ai.modern_device': (l10n, _) =>
      l10n.settingsLocalAiModernDevice,
  'settings.local_ai.can_disable': (l10n, _) => l10n.settingsLocalAiCanDisable,
  'settings.local_ai.enable_confirm': (l10n, _) =>
      l10n.settingsLocalAiEnableConfirm,
  'settings.local_ai.hf_token': (l10n, _) => l10n.settingsLocalAiHfToken,
  'settings.local_ai.hf_token_hint': (l10n, _) =>
      l10n.settingsLocalAiHfTokenHint,
  'settings.local_ai.hf_token_subtitle': (l10n, _) =>
      l10n.settingsLocalAiHfTokenSubtitle,
  'ai.disabled.title': (l10n, _) => l10n.aiDisabledTitle,
  'ai.disabled.subtitle': (l10n, _) => l10n.aiDisabledSubtitle,
  'ai.oom.title': (l10n, _) => l10n.aiOomTitle,
  'ai.oom.subtitle': (l10n, _) => l10n.aiOomSubtitle,
