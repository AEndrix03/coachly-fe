...
abstract class AppLocalizations {
  ...
  /// Migrated from ai.create_workout
  ///
  /// In en, this message translates to:
  /// **'Create Workout'**
  String get aiCreateWorkout;

  /// Migrated from ai.analyze_progress
  ///
  /// In en, this message translates to:
  /// **'Analyze progress'**
  String get aiAnalyzeProgress;

  /// Migrated from ai.goal_tips
  ///
  /// In en, this message translates to:
  /// **'Goal tips'**
  String get aiGoalTips;

  /// Migrated from ai.greeting
  ///
  /// In en, this message translates to:
  /// **'Hi! I am your AI Coach. I can help with workout plans, progress analysis, nutrition tips, and more. How can I help today? 💪'**
  String get aiGreeting;

  /// Migrated from ai.sample_question
  ///
  /// In en, this message translates to:
  /// **'I am doing bench press and feel tired. Should I continue?'**
  String get aiSampleQuestion;

  /// Migrated from ai.sample_answer
  ///
  /// In en, this message translates to:
  ...
  /// Migrated from ai.header_ready
  ///
  /// In en, this message translates to:
  /// **'Always ready to help'**
  String get aiHeaderReady;

  /// Migrated from ai.plan_week
  ///
  /// In en, this message translates to:
  /// **'Plan week'**
  String get aiPlanWeek;

  /// Migrated from ai.write_message
  ///
  /// In en, this message translates to:
  /// **'Write your message...'**
  String get aiWriteMessage;

  /// Migrated from ai.loading
  ///
  /// In en, this message translates to:
  /// **'Loading AI Coach...'**
  String get aiLoading;

  /// Migrated from ai.monitor_workout
  ///
  /// In en, this message translates to:
  /// **'Monitoring your workout'**
  String get aiMonitorWorkout;

  /// Migrated from ai.listening
  ///
  /// In en, this message translates to:
  /// **'LISTENING...'**
  String get aiListening;

  /// Migrated from ai.speak_now
  ///
  /// In en, this message translates to:
  /// **'Speak now...'**
  String get aiSpeakNow;

  /// Migrated from ai.send
  ///
  /// In en, this message translates to:
  /// **'Send'**
  String get aiSend;

  /// Migrated from ai.write_or_speak
  ///
  /// In en, this message translates to:
  /// **'Write or speak...'**
  String get aiWriteOrSpeak;

  /// Migrated from ai.live
  ///
  /// In en, this message translates to:
  /// **'LIVE'**
  String get aiLive;

  /// Migrated from ai.now
  ///
  /// In en, this message translates to:
  /// **'now'**
  String get aiNow;

  /// Migrated from ai.minutes_ago
  ///
  /// In en, this message translates to:
  /// **'{value}m ago'**
  String aiMinutesAgo(String value);

  /// Migrated from ai.context_line
  ///
  /// In en, this message translates to:
  /// **'{exercise} · Set {current}/{total} · {weight} kg · {time}'**
  ...
  /// Migrated from ai.quick.adjust
  ///
  /// In en, this message translates to:
  /// **'ADJUST'**
  String get aiQuickAdjust;

  /// Migrated from ai.quick.progress
  ///
  /// In en, this message translates to:
  /// **'PROGRESS'**
  String get aiQuickProgress;

  /// Migrated from ai.quick.fatigue
  ///
  /// In en, this message translates to:
  /// **'FATIGUE'**
  String get aiQuickFatigue;

  /// Migrated from ai.quick.next
  ///
  /// In en, this message translates to:
  /// **'NEXT'**
  String get aiQuickNext;

  /// Migrated from ai.quick.nutrition
  ///
  /// In en, this message translates to:
  /// **'NUTRITION'**
  String get aiQuickNutrition;

  /// Migrated from ai.default_opening
  ///
  /// In en, this message translates to:
  /// **'I am ready. Tell me how you feel in this set and I will guide you.'**
  String get aiDefaultOpening;

  /// Migrated from ai.model_unavailable
  ///
  /// In en, this message translates to:
  /// **'Model not available now. I will use simplified offline answers.'**
  String get aiModelUnavailable;

  /// Migrated from ai.model_loading_retry
  ///
  /// In en, this message translates to:
  /// **'AI model is still warming up. Retry in a few seconds.'**
  String get aiModelLoadingRetry;

  /// Migrated from ai.retry_short
  ///
  /// In en, this message translates to:
  /// **'I did not complete the answer. Try again with a shorter request.'**
  String get aiRetryShort;

  /// Migrated from ai.json_fallback
  ///
  /// In en, this message translates to:
  /// **'Rephrase briefly: I can give you a practical tip right now.'**
  String get aiJsonFallback;

  /// Migrated from ai.message_fallback
  ///
  /// In en, this message translates to:
  /// **'I am tracking in real time: keep control and technical quality.'**
  String get aiMessageFallback;

  /// Migrated from ai.context_loading_exercise
  ///
  /// In en, this message translates to:
  /// **'Loading exercise'**
  String get aiContextLoadingExercise;

  /// Migrated from ai.prompt.system.en
  ///
  /// In en, this message translates to:
  ...
  /// Migrated from ai.prompt.context_title
  ///
  /// In en, this message translates to:
  /// **'[WORKOUT CONTEXT]'**
  String get aiPromptContextTitle;

  /// Migrated from ai.prompt.user_title
  ///
  /// In en, this message translates to:
  /// **'[USER MESSAGE]'**
  String get aiPromptUserTitle;

  /// Migrated from ai.prompt.exercise_line
  ///
  /// In en, this message translates to:
  /// **'Exercise: {name} | Set: {current}/{total}'**
  String aiPromptExerciseLine(String name, String current, String total);

  /// Migrated from ai.prompt.weight_line
  ///
  /// In en, this message translates to:
  /// **'Weight: {weight}kg x {reps} target reps'**
  String aiPromptWeightLine(String weight, String reps);

  /// Migrated from ai.prompt.fatigue_line
  ///
  /// In en, this message translates to:
  /// **'Fatigue index: {value}'**
  String aiPromptFatigueLine(String value);

  /// Migrated from ai.prompt.recent_weights_line
  ///
  /// In en, this message translates to:
  /// **'Recent weight history: {value}'**
  String aiPromptRecentWeightsLine(String value);

  /// Migrated from ai.prompt.minutes_line
  ///
  /// In en, this message translates to:
  /// **'Session minutes: {value}'**
  String aiPromptMinutesLine(String value);

  /// Migrated from ai.offline.body
  ///
  /// In en, this message translates to:
  /// **'Fatigue {value}% on {exercise}'**
  String aiOfflineBody(String value, String exercise);

  /// Migrated from ai.offline.body_default
  ///
  /// In en, this message translates to:
  /// **'Keep clean technique and regular recovery'**
  String get aiOfflineBodyDefault;

  /// Migrated from ai.offline.message
  ///
  /// In en, this message translates to:
  /// **'I read: {message}. Keep controlled pace and stable form now.'**
  String aiOfflineMessage(String message);

  /// Migrated from ai.offline.label
  ///
  /// In en, this message translates to:
  /// **'QUICK CHECK'**
  String get aiOfflineLabel;

  /// Migrated from ai.download.title
  ///
  /// In en, this message translates to:
  /// **'AI Model Required'**
  String get aiDownloadTitle;

  /// Migrated from ai.download.subtitle
  ///
  /// In en, this message translates to:
  /// **'Qwen2.5 1.5B · 1.5 GB · runs fully offline'**
  String get aiDownloadSubtitle;

  /// Migrated from ai.download.description
  ///
  /// In en, this message translates to:
  ...
  /// Migrated from ai.download.button
  ///
  /// In en, this message translates to:
  /// **'Download'**
  String get aiDownloadButton;

  /// Migrated from ai.download.progress
  ///
  /// In en, this message translates to:
  /// **'Downloading... {progress}%'**
  String aiDownloadProgress(String progress);

  /// Migrated from ai.download.error
  ///
  /// In en, this message translates to:
  /// **'Download failed. Tap to retry.'**
  String get aiDownloadError;

  /// Migrated from settings.local_ai.section
  ///
  /// In en, this message translates to:
  /// **'AI Coach'**
  String get settingsLocalAiSection;

  /// Migrated from settings.local_ai.toggle
  ///
  /// In en, this message translates to:
  /// **'Use local AI'**
  String get settingsLocalAiToggle;

  /// Migrated from settings.local_ai.toggle_subtitle
  ///
  /// In en, this message translates to:
  /// **'Run AI entirely on your device, offline'**
  String get settingsLocalAiToggleSubtitle;

  /// Migrated from settings.local_ai.model_quality
  ///
  /// In en, this message translates to:
  /// **'Model quality'**
  String get settingsLocalAiModelQuality;

  /// Migrated from settings.local_ai.model_minimal
  ///
  /// In en, this message translates to:
  /// **'Minimal'**
  String get settingsLocalAiModelMinimal;

  /// Migrated from settings.local_ai.model_good
  ///
  /// In en, this message translates to:
  /// **'Good'**
  String get settingsLocalAiModelGood;

  /// Migrated from settings.local_ai.model_best
  ///
  /// In en, this message translates to:
  /// **'Best'**
  String get settingsLocalAiModelBest;

  /// Migrated from settings.local_ai.uninstall_all
  ///
  /// In en, this message translates to:
  /// **'Uninstall downloaded models'**
  String get settingsLocalAiUninstallAll;

  /// Migrated from settings.local_ai.uninstall_title
  ///
  /// In en, this message translates to:
  /// **'Uninstall models?'**
  String get settingsLocalAiUninstallTitle;

  /// Migrated from settings.local_ai.uninstall_body
  ///
  /// In en, this message translates to:
  /// **'All downloaded AI models will be removed from your device.'**
  String get settingsLocalAiUninstallBody;

  /// Migrated from settings.local_ai.uninstall_confirm
  ///
  /// In en, this message translates to:
  /// **'Uninstall'**
  String get settingsLocalAiUninstallConfirm;

  /// Migrated from settings.local_ai.enable_title
  ///
  /// In en, this message translates to:
  /// **'Enable local AI?'**
  String get settingsLocalAiEnableTitle;

  /// Migrated from settings.local_ai.storage_info
  ///
  /// In en, this message translates to:
  /// **'Storage required: {size}'**
  String settingsLocalAiStorageInfo(String size);

  /// Migrated from settings.local_ai.no_cost
  ///
  /// In en, this message translates to:
  /// **'No additional costs'**
  String get settingsLocalAiNoCost;

  /// Migrated from settings.local_ai.modern_device
  ///
  /// In en, this message translates to:
  /// **'Designed for modern devices'**
  String get settingsLocalAiModernDevice;

  /// Migrated from settings.local_ai.can_disable
  ///
  /// In en, this message translates to:
  /// **'You can disable it at any time'**
  String get settingsLocalAiCanDisable;

  /// Migrated from settings.local_ai.enable_confirm
  ///
  /// In en, this message translates to:
  /// **'Enable'**
  String get settingsLocalAiEnableConfirm;

  /// Migrated from settings.local_ai.hf_token
  ///
  /// In en, this message translates to:
  /// **'HuggingFace Token (optional)'**
  String get settingsLocalAiHfToken;

  /// Migrated from settings.local_ai.hf_token_hint
  ///
  /// In en, this message translates to:
  /// **'hf_...'**
  String get settingsLocalAiHfTokenHint;

  /// Migrated from settings.local_ai.hf_token_subtitle
  ///
  /// In en, this message translates to:
  /// **'Required to download gated models from HuggingFace'**
  String get settingsLocalAiHfTokenSubtitle;

  /// Migrated from ai.disabled.title
  ///
  /// In en, this message translates to:
  /// **'Local AI disabled'**
  String get aiDisabledTitle;

  /// Migrated from ai.disabled.subtitle
  ///
  /// In en, this message translates to:
  /// **'Enable local AI in your profile settings to use the AI coach during workouts.'**
  String get aiDisabledSubtitle;

  /// Migrated from ai.oom.title
  ///
  /// In en, this message translates to:
  /// **'Not enough memory'**
  String get aiOomTitle;

  /// Migrated from ai.oom.subtitle
  ///
  /// In en, this message translates to:
